...
import { ConsumedCapacity, AttributeValue } from '@aws-sdk/client-dynamodb';
...
export abstract class DynamoDbPaginator implements DynamoDbPaginatorInterface {
    ...
    private _count = 0;
    private _lastKey?: Record<string, AttributeValue>;
     ...
     */
    get lastEvaluatedKey(): Record<string, AttributeValue>|undefined {
