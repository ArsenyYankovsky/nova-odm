...
describe('ScanPaginator', () => {
    ...
    it(
        ...
        async () => {
            ...
            const result: any[] = [];
            for await (const res of new ScanPaginator(mockDynamoDbClient as any, {TableName: 'foo'})) {
    ...
    it('should provide access to the last evaluated key', async () => {
        ...
        const paginator = new ScanPaginator(mockDynamoDbClient as any, {TableName: 'foo'});
